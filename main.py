...
def train(data):
    ...
    for epoch in range(30):
        for i, (imagedata, labeldata) in enumerate(data):
            ...
            _,logits_scale_128_upsampled_to_256_sigmoid =  torch.where(logits_scale_128_upsampled_to_256_sigmoid>0.5,mask, background)
            _,logits_scale_256_upsampled_to_256_sigmoid =  torch.where(logits_scale_256_upsampled_to_256_sigmoid>0.5,mask, background)
